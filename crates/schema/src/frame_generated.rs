...
pub mod bridge {
    ...
    pub mod schema {
        ...
        pub const ENUM_VALUES_COLOR_FORMAT: [ColorFormat; 3] =
            [ColorFormat::BGR, ColorFormat::RGB, ColorFormat::GRAY];
        ...
        impl ColorFormat {
            ...
            pub const ENUM_VALUES: &'static [Self] = &[Self::BGR, Self::RGB, Self::GRAY];
        ...
        impl<'a> Frame<'a> {
            ...
            pub fn frame_number(&self) -> u64 {
                ...
                unsafe {
                    self._tab
                        .get::<u64>(Frame::VT_FRAME_NUMBER, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn timestamp_ns(&self) -> u64 {
                ...
                unsafe {
                    self._tab
                        .get::<u64>(Frame::VT_TIMESTAMP_NS, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            ...
            pub fn format(&self) -> ColorFormat {
                ...
                unsafe {
                    self._tab
                        .get::<ColorFormat>(Frame::VT_FORMAT, Some(ColorFormat::BGR))
                        .unwrap()
                }
            }
            #[inline]
        ...
        impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FrameBuilder<'a, 'b, A> {
            ...
            pub fn add_frame_number(&mut self, frame_number: u64) {
                self.fbb_
                    .push_slot::<u64>(Frame::VT_FRAME_NUMBER, frame_number, 0);
            }
            #[inline]
            pub fn add_timestamp_ns(&mut self, timestamp_ns: u64) {
                self.fbb_
                    .push_slot::<u64>(Frame::VT_TIMESTAMP_NS, timestamp_ns, 0);
            }
            #[inline]
            pub fn add_camera_id(&mut self, camera_id: u32) {
                self.fbb_
                    .push_slot::<u32>(Frame::VT_CAMERA_ID, camera_id, 0);
            }
            #[inline]
            ...
            pub fn add_format(&mut self, format: ColorFormat) {
                self.fbb_
                    .push_slot::<ColorFormat>(Frame::VT_FORMAT, format, ColorFormat::BGR);
            }
            #[inline]
            pub fn add_pixels(
                &mut self,
                pixels: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
            ) {
                self.fbb_
